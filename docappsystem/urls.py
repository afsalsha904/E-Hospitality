...
urlpatterns = [
    ...
    path('create-checkout-session/<int:appointment_id>/', userviews.create_checkout_session, name='create_checkout_session'),
    path('ViewAppointmentHistory/success/', userviews.payment_success, name='payment_success'),
    path('ViewAppointmentHistory/cancel/', userviews.payment_cancel, name='payment_cancel'),
    path('topics/', userviews.topic_list, name='topic_list'),
    path('topics/<int:topic_id>/', userviews.resource_list, name='resource_list'),
